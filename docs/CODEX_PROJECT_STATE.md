...
- Perspective calibration V1: [findings](../demo/hospital_integration/repair_candidates/perspective_calibration_v1/findings.md), [native comparison](../demo/hospital_integration/repair_candidates/perspective_calibration_v1/perspective_calibration_review.png), [Godot comparison](../demo/hospital_integration/repair_candidates/perspective_calibration_v1/perspective_calibration_godot.png). Three reference-only candidates (`reception_counter_straight_01`, `bedside_cabinet_01`, `medical_cart_base_01`) establish the rectangular-grid camera, bottom-center scale and controlled hard-alpha palette. Godot `PERSPECTIVE_CALIBRATION_REVIEW_PASS` verifies integer rendering and matching feet beside the adult, bed and chair. **Awaiting human visual review**; production/staging/manifest/approvals unchanged. Acceptance unlocks the remaining 141 repairs in R1–R9.
...
4. Human-review the completed V1 camera calibration (`reception_counter_straight_01`, `bedside_cabinet_01`, `medical_cart_base_01`). If accepted, use it as the locked construction basis for R1–R9 from [PERSPECTIVE_REPAIR_PLAN.md](PERSPECTIVE_REPAIR_PLAN.md). This includes brochure-rack/plant cleanup; the retained benches still receive their separate proportion/scale fix.
