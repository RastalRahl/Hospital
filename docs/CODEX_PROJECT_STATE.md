...
- Bedside cabinet V2 art pilot: [findings](../demo/hospital_integration/repair_candidates/perspective_cabinet_v2/findings.md), [native comparison](../demo/hospital_integration/repair_candidates/perspective_cabinet_v2/bedside_cabinet_art_review.png), [Godot comparison](../demo/hospital_integration/repair_candidates/perspective_cabinet_v2/bedside_cabinet_art_godot.png). Final 34x36 candidate combines the corrected camera with 13-color hard-alpha art, constructed top/drawer/cupboard hardware and adult-relative scale. Godot `BEDSIDE_CABINET_ART_REVIEW_PASS`; **awaiting human visual review**. Production/staging/manifest/approval remain unchanged.
...
4. Human-review the bedside cabinet V2 art pilot. If accepted, rebuild `reception_counter_straight_01` and `medical_cart_base_01` to the same detail/cluster bar while retaining the V1 perspective contract; review the three together before R1–R9. This includes brochure-rack/plant cleanup; the retained benches still receive their separate proportion/scale fix.
