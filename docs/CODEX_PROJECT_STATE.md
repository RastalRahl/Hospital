...
- Bedside cabinet V1–V3 are retained as rejected calibration evidence. Bedside cabinet V4 is the active pilot: [findings](../demo/hospital_integration/repair_candidates/perspective_cabinet_v4/findings.md), [native comparison](../demo/hospital_integration/repair_candidates/perspective_cabinet_v4/bedside_cabinet_v4_review.png), [Godot comparison](../demo/hospital_integration/repair_candidates/perspective_cabinet_v4/bedside_cabinet_v4_godot.png). The 32x36 candidate uses 12 hard-alpha colors, one molded work surface, a subordinate drawer, broad warm door clusters and a purposeful caster silhouette at the same 1x1 bottom-center contract. Godot `BEDSIDE_CABINET_V4_REVIEW_PASS`; **awaiting human visual review**. Production/staging/manifest/approval remain unchanged.
...
4. Human-review the bedside cabinet V4 art pilot. If accepted, rebuild `reception_counter_straight_01` and `medical_cart_base_01` to the same single-surface, exterior-outline and purposeful-base bar while retaining the V1 perspective contract; review the three together before R1–R9. This includes brochure-rack/plant cleanup; the retained benches still receive their separate proportion/scale fix.
